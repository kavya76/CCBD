...
public class MainActivity extends AppCompatActivity implements
    ...
    private DatabaseReference getStepsRef(String ref) {
        ...
        return mDatabase.child("Steps").child(formattedDate).child(userId).child(ref);
    }
    ...
    private void createDataSeries1() {
        ...
        seriesItem.addArcSeriesItemListener(new SeriesItem.SeriesItemListener() {
            ...
            public void onSeriesItemAnimationProgress(float percentComplete, float currentPosition) {
                ...
                getStepsRef("totalsteps").setValue(currentPosition);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.item4:
                ...
                break;
            case R.id.item5:
                Intent y = new Intent(this,BmiActivity.class);
               startActivity(y);
                finish();
